...
def getOutputList():
    ...
    for hgvs in variant_list:
        ...
        # TODO: separate next two lines out of for loop, run as script, run loop again at if not res
        else:
            ...
            if not res:
                ...
                str_result = "coding_impact: {} | splicing_impact: {} | SIFT: {} | PolyPhen: {} | VEP MaxEntScan Ref: {} | VEP MaxEntScan Alt: {} | VEP MaxEntScan Diff: {} | SpliceAI: {} | gnomad_variant: {} ".format(
                    res["coding_impact"], res["splicing_impact"], res["sift_score"], res["polyphen_score"],
                    res["maxentscan_ref"], res["maxentscan_alt"], res["maxentscan_diff"], res["spliceai_pred"],
                    res["gnomad_variant"])
